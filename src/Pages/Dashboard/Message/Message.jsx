                    ...
                    data.map((item, index) => {
                      ...
                      <div className={styleForm.recentMessage}>
                        ...
                        <svg className={styleForm.recentMessageIcon} width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path d="M35.98 28.79V32.79C35.98 33.05 35.97 33.3 35.94 33.54C35.71 36.24 34.12 37.58 31.19 37.58H30.79C30.54 37.58 30.3 37.7 30.15 37.9L28.95 39.5C28.42 40.21 27.56 40.21 27.03 39.5L25.83 37.9C25.7 37.73 25.41 37.58 25.19 37.58H24.79C21.6 37.58 20 36.79 20 32.79V28.79C20 25.86 21.35 24.27 24.04 24.04C24.28 24.01 24.53 24 24.79 24H31.19C34.38 24 35.98 25.6 35.98 28.79Z" stroke="white" strokeMiterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M39.98 24.79V28.79C39.98 31.73 38.63 33.31 35.94 33.54C35.97 33.3 35.98 33.05 35.98 32.79V28.79C35.98 25.6 34.38 24 31.19 24H24.79C24.53 24 24.28 24.01 24.04 24.04C24.27 21.35 25.86 20 28.79 20H35.19C38.38 20 39.98 21.6 39.98 24.79Z" stroke="white" strokeMiterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M31.4955 31.25H31.5045" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M27.9955 31.25H28.0045" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M24.4955 31.25H24.5045" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                      </div>
